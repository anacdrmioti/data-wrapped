...
from karaoke.Karaoke import render_karaoke
from chatbot.chatbot_ui import render_chatbot
from preprocesamiento_datos.limpieza_datos import (
...
# ------------------ PANTALLA KARAOKE DESDE RECOMENDACION ------------------
    ...
    hero(
        '🎤<span class="grad"> Karaoke de tu recomendación</span>',
